      ...
      <Router>
        <div>
          <Switch>
            ...
            <Route exact path="/admin" render={() => <Admin config={config} />} />
            <Route exact path="/token-failed" render={() => <TokenFailed config={config} />} />
            <Route
              exact
              path="/admin/city/:cityId"
              render={meta => <AdminCity config={config} cityId={meta.match.params.cityId} />}
            />
            <Route
              exact
            ...
            />
            <Route exact path="/admin/login" render={() => <Login config={config} />} />
            <Route exact path="/admin/signup" render={() => <SignUp config={config} />} />
            <Route exact path="/admin/signout" render={() => <SignOut config={config} />} />
            <Route
              exact
              ...
              render={meta => (
                <Neighborhood
                  ...
                  fetchingLocations={
                    meta.location.state ? meta.location.state.fetchingLocations : null
                  }
                />
              )}
            />
